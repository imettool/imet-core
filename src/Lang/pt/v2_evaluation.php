...
return [
    ...
    'steps' => [
        'context' => 'Este domínio do ciclo de gestão resume as evidências do Contexto de Intervenção (CTX) para estabelecer prioridades operacionais. Cada elemento de conservação – como espécies chave, habitats, vulnerabilidades às alterações climáticas e serviços ecossistémicos legais – deve ser avaliado com base no seu nível actual de integração na gestão ou no seu potencial para se tornar o foco de novos objectivos (CX). A informação é importada directamente do CTX (p. ex. espécies chave, habitats e pontuações de ameaças), importada e classificada para facilitar a avaliação (p. ex. ameaças e serviços ecossistémicos), ou especificamente avaliada quando estão envolvidos factores externos (C2: apoios/restrições externos). Os elementos marcados como «Priorizar na gestão» são transferidos para os domínios seguintes (Planeamento, Entradas, Processos, Saídas e Resultados) para avaliação detalhada. Os objectivos numerados CX daí resultantes servem de referência fiável para o planeamento, a orçamentação, a implementação e a monitorização.',
        'planning' => 'Este domínio avalia a adequação do quadro de planeamento da área protegida à sua gestão e a sua incorporação efectiva das prioridades e dos elementos de conservação identificados no Contexto de gestão. Avalia em que medida os instrumentos de planeamento jurídicos, institucionais e operacionais estão orientados para resultados e fornecem orientações claras sobre como alcançar os objectivos de gestão. A análise centra-se na coerência e na adequação dos instrumentos existentes, como o quadro jurídico, a configuração espacial e os planos de gestão e de trabalho, e na sua capacidade de integrar valores prioritários, ameaças e factores externos.',
        'inputs' => 'O domínio das Entradas avalia os recursos que permitem às áreas protegidas converter os planos em acção efectiva. Isto inclui avaliar a disponibilidade, a adequação e a fiabilidade da informação, dos recursos humanos, dos recursos financeiros, dos equipamentos e dos meios operacionais necessários à gestão. A análise verifica se o sítio tem acesso aos dados necessários, se os efectivos e as competências são suficientes, se a orçamentação e o financiamento são previsíveis e se as infra-estruturas e a logística apoiam as operações diárias. A avaliação identifica lacunas que possam dificultar a implementação, bem como pontos fortes que possam facilitar respostas de gestão eficientes e atempadas. A análise do domínio das Entradas permite aos gestores identificar as necessidades fundamentais de recursos e assegurar que as condições para uma gestão eficaz estão reunidas antes de avaliar processos e resultados.',
        'process' => 'O domínio dos Processos examina as funções de gestão essenciais que traduzem as intenções em acção concreta. É o motor operacional do ciclo de gestão. Com base nas prioridades identificadas no contexto, nos objectivos definidos durante o planeamento e nos recursos avaliados nas entradas, as equipas de gestão do sítio realizam as actividades diárias que geram saídas e, ao longo do tempo, influenciam os resultados. <br/><br/>No IMET, este domínio é analisado através de seis subelementos: sistemas de gestão interna; protecção e aplicação da lei; relações com as partes interessadas; gestão do turismo; monitorização e investigação; e gestão das alterações climáticas e dos serviços ecossistémicos. Em conjunto, estes subelementos proporcionam uma visão detalhada da consistência e da eficácia do funcionamento do sistema de gestão na prática. A avaliação dos Processos evidencia os pontos fortes organizacionais e identifica os estrangulamentos operacionais. Clarifica também onde são necessárias melhorias na coordenação, nos procedimentos ou na implementação para que as intervenções planeadas produzam os resultados esperados.',
        'outputs' => 'O domínio das Saídas capta os resultados tangíveis decorrentes da implementação das actividades planeadas ao longo de um período anual ou plurianual. As saídas representam aquilo que a equipa de gestão entrega através das suas acções, como trabalhos de restauro concluídos, patrulhas realizadas, acções de envolvimento comunitário efectuadas, infra-estruturas mantidas ou dados de monitorização recolhidos. Reflectem o grau de concretização dos objectivos de gestão anuais ou plurianuais, estando estes por sua vez alinhados com a visão de conservação a mais longo prazo da área protegida. <br/><br/>A análise das saídas verifica não só o volume de trabalho realizado, mas também a sua relevância e coerência com as prioridades definidas nos planos de gestão. Isto ajuda a determinar se os processos e os recursos mobilizados estão a produzir eficazmente os resultados esperados a curto e médio prazo. Ao avaliar as saídas, os gestores podem compreender o desempenho da implementação, ajustar as estratégias operacionais e reforçar a ligação entre as intenções planeadas e os resultados de conservação a longo prazo.',
        'outcomes' => 'O domínio dos Resultados avalia os efeitos e impactos a médio e longo prazo da gestão sobre a área protegida e as comunidades circundantes. São examinadas três dimensões: a medida em que a área protegida progride para os seus objectivos de conservação a longo prazo; o estado e a tendência dos elementos de conservação prioritários; e o impacto positivo ou negativo da gestão sobre o bem-estar das populações locais que vivem em torno do sítio. <br/><br/>Ao contrário das Saídas, que reflectem a entrega a curto prazo, os Resultados captam mudanças reais nos ecossistemas, nas espécies, nos recursos naturais e nos meios de subsistência humanos decorrentes de uma acção de gestão sustentada. O IMET avalia se as metas de conservação evoluem na direcção certa, se os valores ecológicos chave estão a estabilizar ou a recuperar, e se a presença e a gestão da área protegida têm um efeito positivo ou negativo na qualidade de vida das comunidades. Este domínio fornece assim evidências essenciais para uma gestão adaptativa, ligando o desempenho da implementação aos impactos ecológicos e sociais mais amplos que definem o sucesso a longo prazo.',
    ],
    'removed_op2' => '<b>Nota</b>: Nas versões anteriores, a distinção entre as realizações no âmbito de O/P1 e O/P2 revelou-se difícil na prática, uma vez que estas componentes estão estreitamente interligadas. Por conseguinte, <b>O/P2 foi removido</b> enquanto categoria analítica separada. A numeração original de O/P3 e O/P4 foi mantida para assegurar a coerência com as versões anteriores do IMET.',
];

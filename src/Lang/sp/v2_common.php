...
return [
    ...
    'assessment' => [
        ...
        'C1' => 'Valores e importancia',
        'C2' => 'Restricciones externas o de apoyo',
        'C3' => 'Amenazas',

        'PRA' => 'Sistemas y procesos de gestión interna',
        'PRB' => 'Gestión/protección de los valores',
        'PRC' => 'Relaciones con los socios',
        'PRD' => 'La gestión del turismo',

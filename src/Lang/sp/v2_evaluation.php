...
return [
    ...
    'EquipmentMaintenance' => [
        ...
        'module_info_Rating' => [
            'Evaluar el nivel de mantenimiento de las infraestructuras, los equipamientos y las instalaciones en relación con los requisitos de gestión del área protegida (a partir del análisis del contexto de intervención, punto CTX 3.3)',
        ],
    ],
    ...
    'steps' => [
        'context' => 'Este dominio del ciclo de gestión resume las evidencias del Contexto de Intervención (CTX) para establecer prioridades operativas. Cada elemento de conservación – como especies clave, hábitats, vulnerabilidades al cambio climático y servicios ecosistémicos legales – debe evaluarse en función de su nivel actual de integración en la gestión o de su potencial para convertirse en el foco de nuevos objetivos (CX). La información se importa directamente del CTX (p. ej. especies clave, hábitats y puntuaciones de amenazas), se importa y clasifica para facilitar la evaluación (p. ej. amenazas y servicios ecosistémicos), o se evalúa específicamente cuando intervienen factores externos (C2: apoyos/restricciones externos). Los elementos marcados como «Priorizar en la gestión» se transfieren a los dominios siguientes (Planificación, Insumos, Procesos, Productos y Resultados) para una evaluación detallada. Los objetivos numerados CX resultantes sirven de referencia fiable para la planificación, la presupuestación, la implementación y el seguimiento.',
        'planning' => 'Este dominio evalúa la adecuación del marco de planificación del área protegida a su gestión y su incorporación efectiva de las prioridades y los elementos de conservación identificados en el Contexto de gestión. Evalúa en qué medida los instrumentos de planificación jurídicos, institucionales y operativos están orientados a resultados y ofrecen orientaciones claras sobre cómo alcanzar los objetivos de gestión. El análisis se centra en la coherencia y la adecuación de los instrumentos existentes, como el marco jurídico, el diseño espacial y los planes de gestión y de trabajo, y en su capacidad de integrar valores prioritarios, amenazas y factores externos.',
        'inputs' => 'El dominio de los Insumos evalúa los recursos que permiten a las áreas protegidas convertir los planes en acción efectiva. Esto incluye evaluar la disponibilidad, la adecuación y la fiabilidad de la información, los recursos humanos, los recursos financieros, los equipamientos y los medios operativos necesarios para la gestión. El análisis verifica si el sitio tiene acceso a los datos necesarios, si las plantillas y las competencias son suficientes, si la presupuestación y la financiación son previsibles y si las infraestructuras y la logística sostienen las operaciones diarias. La evaluación identifica las carencias que puedan dificultar la implementación, así como las fortalezas que puedan facilitar respuestas de gestión eficientes y oportunas. El examen del dominio de los Insumos permite a los gestores identificar las necesidades fundamentales de recursos y asegurar que las condiciones para una gestión eficaz están dadas antes de evaluar procesos y resultados.',
        'process' => 'El dominio de los Procesos examina las funciones de gestión esenciales que traducen las intenciones en acción concreta. Es el motor operativo del ciclo de gestión. A partir de las prioridades identificadas en el contexto, los objetivos definidos durante la planificación y los recursos evaluados en los insumos, los equipos de gestión del sitio llevan a cabo las actividades diarias que generan productos y, con el tiempo, influyen en los resultados. <br/><br/>En el IMET, este dominio se analiza a través de seis subelementos: sistemas de gestión interna; protección y aplicación de la ley; relaciones con las partes interesadas; gestión del turismo; seguimiento e investigación; y gestión del cambio climático y de los servicios ecosistémicos. En conjunto, estos subelementos ofrecen una visión detallada de la constancia y la eficacia con que funciona el sistema de gestión en la práctica. La evaluación de los Procesos pone de relieve las fortalezas organizativas e identifica los cuellos de botella operativos. Aclara asimismo dónde se necesitan mejoras en la coordinación, los procedimientos o la implementación para que las intervenciones planificadas produzcan los resultados esperados.',
        'outputs' => 'El dominio de los Productos recoge los resultados tangibles derivados de la implementación de las actividades planificadas a lo largo de un periodo anual o plurianual. Los productos representan lo que el equipo de gestión entrega mediante sus acciones, como trabajos de restauración finalizados, patrullas realizadas, acciones de participación comunitaria celebradas, infraestructuras mantenidas o datos de seguimiento recogidos. Reflejan el grado de consecución de los objetivos de gestión anuales o plurianuales, objetivos que a su vez están alineados con la visión de conservación a más largo plazo del área protegida. <br/><br/>El análisis de los productos verifica no solo el volumen de trabajo realizado, sino también su pertinencia y coherencia con las prioridades definidas en los planes de gestión. Esto ayuda a determinar si los procesos y los recursos movilizados están produciendo eficazmente los resultados esperados a corto y medio plazo. Al evaluar los productos, los gestores pueden comprender el rendimiento de la implementación, ajustar las estrategias operativas y reforzar el vínculo entre las intenciones planificadas y los resultados de conservación a largo plazo.',
        'outcomes' => 'El dominio de los Resultados evalúa los efectos e impactos a medio y largo plazo de la gestión sobre el área protegida y las comunidades circundantes. Se examinan tres dimensiones: la medida en que el área protegida avanza hacia sus objetivos de conservación a largo plazo; el estado y la tendencia de los elementos de conservación prioritarios; y el impacto positivo o negativo de la gestión sobre el bienestar de las poblaciones locales que viven en torno al sitio. <br/><br/>A diferencia de los Productos, que reflejan la entrega a corto plazo, los Resultados captan cambios reales en los ecosistemas, las especies, los recursos naturales y los medios de vida humanos derivados de una acción de gestión sostenida. El IMET evalúa si las metas de conservación avanzan en la dirección correcta, si los valores ecológicos clave se están estabilizando o recuperando, y si la presencia y la gestión del área protegida tienen un efecto positivo o negativo en la calidad de vida de las comunidades. Este dominio aporta, por tanto, evidencias esenciales para una gestión adaptativa, vinculando el rendimiento de la implementación a los impactos ecológicos y sociales más amplios que definen el éxito a largo plazo.',
    ],
    'removed_op2' => '<b>Nota</b>: En versiones anteriores, la distinción entre los logros correspondientes a O/P1 y O/P2 resultó difícil en la práctica, ya que estos componentes están estrechamente interrelacionados. En consecuencia, <b>O/P2 se ha eliminado</b> como categoría analítica separada. Se ha mantenido la numeración original de O/P3 y O/P4 para asegurar la coherencia con las versiones anteriores del IMET.',
];

...
return [
    ...
    'EvidenceOfConnectivity' => [
        ...
        'some_indications' => 'Yes, some indications (limited monitoring, local observations or one-off studies)',
        'strong_evidence' => 'Yes, strong evidence (tagging, telemetry, genetic studies, long-term monitoring orlarval dispersal models)',
    ],
    'EvidencesListConnectivity' => [
        ...
        'telemetry' => 'Telemetry or tagging studies',
        'genetic_studies' => 'Genetic studies',
        'marine_current_models' => 'Marine current models',
        'landscape_fragmentation_analysis' => 'Landscape fragmentation analysis',
        'scientific_publications' => 'Scientific publications',
        'transboundary_agreements' => 'Transboundary agreements',
        'ecological_knowledge' => 'Local or traditional ecological knowledge',
        'staff_observations' => 'Ranger / staff observations',
        'other' => 'Other',
    ],
    'ConnectivityIntegrationInManagementPlan' => [
        'not_considered' => 'Not considered',
        'mentioned_not_operationalised' => 'Mentioned but not operationalised',
        'partially_integrated' => 'Partially integrated (corridor protection, buffer zones, restoration actions)',
        'fully_integrated' => 'Fully integrated at landscape/seascape scale (ecological network approach)',
    ],

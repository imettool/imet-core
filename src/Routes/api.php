...
Route::group(['prefix' => 'api'], function (): void {
    Route::group(['prefix' => 'imet'], function (): void {
        ...
        Route::group(['middleware' => ['auth:api', 'apiValidation']], function (): void {
            ...
            Route::group(['prefix' => '{lang}/scaling-up'], function (): void {
                Route::get('general-info/{wdpa_id}/{year?}', [ApiController::class, 'get_general_info']);
                Route::group(['prefix' => 'groups'], function (): void {
                ...
                Route::group(['prefix' => 'overall'], function (): void {

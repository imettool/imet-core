...
final class EcosystemServicesTendance extends Modules\Component\ImetModule
{
    protected $table = 'context_ecosystem_services_tendance';

    public const int REQUIRED_ACCESS_LEVEL = Role::ACCESS_LEVEL_HIGH;

    public const string BODY_EDIT_BLADE_VIEW = 'imet-core::v1.context.edit.modules.ecosystem_services_tendance';

    public const string BODY_SHOW_BLADE_VIEW = 'imet-core::v1.context.show.modules.ecosystem_services_tendance';

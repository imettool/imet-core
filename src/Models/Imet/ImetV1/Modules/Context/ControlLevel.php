...
final class ControlLevel extends Modules\Component\ImetModule
{
    protected $table = 'context_control_level';

    public const int REQUIRED_ACCESS_LEVEL = Role::ACCESS_LEVEL_HIGH;

    public const string BODY_EDIT_BLADE_VIEW = 'imet-core::v1.context.edit.modules.control_level';
    public const string BODY_SHOW_BLADE_VIEW = 'imet-core::v1.context.show.modules.control_level';

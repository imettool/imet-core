...
use ImetCore\Models\Imet\ImetOecm\Modules\Context\ResponsablesInterviewees;
use ImetCore\Models\Imet\ImetOecm\Modules\Context\ResponsablesInterviewers;
...
class Imet extends BaseImetForm
{
    ...
    public static function get_assessments_list(Request $request, array $relations = [], bool $only_allowed_wdpas = false, array $countries = []): Collection
    {
        ...
        return Imet::query()
            ...
            ->filter(function (Imet $item) use ($request): bool {

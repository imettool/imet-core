    ...
    <li>
        ...
        <ul class="language_selector">
            ...
            @foreach(Role::all_roles() as $role)
                <li>
                    <a href="#"
                       onclick="event.preventDefault(); document.getElementById('switch_to_{{ $role }}_user-form').submit();">
                        {{ $role }}
                    </a>
                    <form id="switch_to_{{ $role }}_user-form" action="{{ route('imet-core::change_user') }}"

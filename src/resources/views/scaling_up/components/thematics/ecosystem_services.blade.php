...
<div v-for="items in data.props.values.items" :key="items.name" class="mt-4">
    <div v-if="data.props.values.ranks[items.name]" class="mt-4">
        <imet_bar_chart :title="items.name" :values="Object.values(data.props.values.ranks[items.name])" :rotate="45"
                        :fields="Object.keys(data.props.values.ranks[items.name])"
                        :colors="[data.props.values.colors[items.name]]"
                        :label="{label: {
                    show: true,
                    position: 'top'
                }}" ></imet_bar_chart>

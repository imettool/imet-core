...
<table class="max-w-full m-auto">
    ...
    <tr>
        ...
        <td style="text-align: left;">
            @if($governance['DateOfCreation']!==null)
                @if(array_key_exists($governance['DateOfCreation'], SelectionList::getList('ImetOECM_DateOfCreation')))
    ...
    <tr>
        <td style="text-align: left;"><b>@lang('imet-core::oecm_context.Governance.fields.SupervisoryInstitution')</b>
        </td>
